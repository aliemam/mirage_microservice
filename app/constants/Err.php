...
class Err
{
    ...
    const AUTH_INVALID_USERNAME_PASSWORD = 'f00401-401';
    const AUTH_INVALID_ACCOUNT_TYPE = 'f00402-401';
    const AUTH_LOGIN_FAILED = 'f00403-401';
    const AUTH_TOKEN_MISS_PARAM = 'f00404-401';
    const AUTH_JWT_INVALID = 'f00405-401';
    const AUTH_JWT_EXPIRED = 'f00406-401';
    const AUTH_JWT_SIGNATURE_INVALID= 'f00407-401';
    const AUTH_JWT_BEFORE_VALID = 'f0048-401';
    const AUTH_HEADER_EMPTY = 'f00409-401';
    const AUTH_HEADER_NOT_FOUND = 'f00410-401';
    const AUTH_JWT_AFTER_VALID = 'f00411-401';
    const AUTH_TOKEN_INVALID_PAYLOAD = 'f00412-401';
    const AUTH_JWT_HASH_KEY_NOT_EXIST = 'f00413-401';
